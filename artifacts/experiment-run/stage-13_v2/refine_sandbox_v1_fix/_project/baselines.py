class BaseEvaluationMethod:
    ...
    def evaluate_response_batch(self, logits, y_true):
        ...
        for i in range(len(logits)):
            # Normalize logits to probs or just use logits for argmax.
            # Using probabilities gives us softer metrics if needed, but argmax is standard for eval.
            ...
            if is_unsafe:
                ...
                # Specifically track the refusal tool
                if pred == 11:
