...
class SyntheticDataset:
    ...
    def __init__(self, num_samples, input_dim=16, num_classes=12):
        ...
        # Very high multiplier ensures base features strongly predict core intent
        self.patterns = [[random.gauss(0, 1) * 5.0 for _ in range(input_dim)] for _ in range(num_classes)]
        ...
        for _ in range(num_samples):
            ...
            feat = [random.gauss(0, 1) * 0.1 + self.patterns[label][i] for i in range(input_dim)]
            self.x.append(feat)
