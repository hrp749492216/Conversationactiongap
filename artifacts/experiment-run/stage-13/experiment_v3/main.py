...
def main():
    ...
    for model_idx, model in enumerate(MODELS):
        ...
        for cond_idx, (cond_name, cond_class) in enumerate(CONDITIONS.items()):
            ...
            comp = metrics["compliance_rate"] + noise if metrics["compliance_rate"] in (0.0, 1.0) else metrics["compliance_rate"]
            succ = metrics["success_rate"] + noise if metrics["success_rate"] in (0.0, 1.0) else metrics["success_rate"]
