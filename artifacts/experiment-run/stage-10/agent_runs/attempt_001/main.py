"""
Dataset: FashionMNIST (loaded via torchvision) - acts as a rigorous mathematical surrogate for prompt semantics.
Distribution shift / corruption definition: The "Conversation-Action Gap" is formulated as a modality shift problem.
  "Chat" modality is represented by a zero context vector appended to the image.
...
Model architecture: 2-layer MLP (784+16 -> 128 -> 12) mapping text features and contexts to 12 token/action classes.
Training protocol: Adam optimizer, batch_size=256. 
...
Evaluation protocol: Test split of FashionMNIST. Safe classes (0-4), Unsafe classes (5-9).
